...
**Ответ:** Допустимо объявление ссылки на интерфейсный тип или использование ее
...
во время выполнения, что позволяет создавать классы позже кода, который вызывает их методы.  
(23) Можно ли выполнить операции:  
1: ```b = i;``` ?  
2: ```i = b;``` ?  
**Ответ:**   
1: Нет, данное сравнение подразумевает идентичность типов.  
2: Нет, данное сравнение подразумевает идентичность типов. 
**Источник:** https://coderoad.ru/4989818/instanceof-Vs-getClass#4989843  
...
**Источник:** Блинов стр. 180.  
5: Интерфейс могут расширяться только другими интерфейсами.  
...
**Ответ:**
Интерфейсы на 100% абстрактны, и единственный способ создать экземпляр интерфейса - создать экземпляр класса, который его реализует. 
Разрешать интерфейсам быть final совершенно бессмысленно.
